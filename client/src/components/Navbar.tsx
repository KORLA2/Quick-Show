...
max-md:absolute max-md:top-0 max-md:left-0 z-50  ${open ? "max-md:translate-x-0 w-full" : "max-md:-translate-x-full"}`}>
...
<button className='px-4 py-1 sm:px-7 sm:py-2 bg-red-700 hover:bg-red-900 transition duration-200 rounded-full '>Login</button>
</div>
